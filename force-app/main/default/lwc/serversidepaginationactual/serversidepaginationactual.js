...
import serversidepagination from '@salesforce/apex/infinteloading.clintsitdepagination'
import getTotalAccountsCount from '@salesforce/apex/infinteloading.getTotalAccountsCount'
const columns = [
    {label:  'Id', fieldName : 'Id'},
    {label:  'Name', fieldName : 'Name'},
    {label:  'Industry', fieldName : 'Industry'}
]
export default class Serversidepaginationactual extends LightningElement {
    ...
    async fetchRecordsFromServer() {
        try {
            let response = await serversidepagination({ pageSize: this.pageSize, lastRecordId: this.lastRecordId });
